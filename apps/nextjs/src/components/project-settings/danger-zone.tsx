...
export function DangerZone({
  ...
  return (
    <Card className="bg-destructive/10 border-destructive/20 w-full">
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  ...
                  <Button
                    variant="destructive"
                    onClick={() =>
                      deleteMutation.mutate({ id: projectId, organizationId })
                    }
                    disabled={!allowDelete || deleteMutation.isPending}
                  >
                    <Trash2 className="h-4 w-4" />
