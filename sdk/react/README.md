...
// Optional: switch from resumable uploads to a single signed PUT upload
...
`uploadMethod` defaults to `"resumable"`. Pass `"put"` when you want a plain non-resumable upload over `fetch`/XHR instead.
