...
export interface AuditEventDefinition {
  ...
  icon: "upload" | "download" | "settings" | "key" | "folder" | "shield" | "delete";
  badgeTone:
    | "blue"
    | "green"
    | "yellow"
...
export const auditEventDefinitions: Record<AuditEventCode, AuditEventDefinition> =
  {
...
export function getAuditEventDefinition(eventCode: string): AuditEventDefinition {
